...
/*
change these values from minified js, this is only for reference dont uncomment it
$('#featured').orbit({
...
(function(d){d.fn.orbit=function(a){a=d.extend({animation:"horizontal-push",animationSpeed:1000,timer:!0,advanceSpeed:10E3,pauseOnHover:!1,startClockOnMouseOut:!1,startClockOnMouseOutAfter:1E3,directionalNav:!0,captions:!0,captionAnimation:"fade",captionAnimationSpeed:600,bullets:!1,bulletThumbs:!1,bulletThumbLocation:"",afterSlideChange:function(){}},a);return this.each(function(){function q(){if(!a.timer||a.timer=="false")return!1;else r.is(":hidden")?s=setInterval(function(){l("next")},a.advanceSpeed):
...
} if (a.bullets) {c.append('<ul class="orbit-bullets bulletList"></ul>'); var C = c.children("ul.orbit-bullets"); for (i = 0; i < p; i++) {k = d("<li class='Slide" + (i + 1) + "'>" + (i + 1) + "</li>"); if (a.bulletThumbs && (w = e.eq(i).data("thumb"))) k = d('<li class="has-thumb">' +
