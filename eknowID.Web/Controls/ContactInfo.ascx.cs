    ...
    public partial class ContactInfo : System.Web.UI.UserControl
    {
        ...
        private void SetContactInfo()
        {
            ...
            if (ContactInfo != null)
            {
                ...
                txtCntPassword.Attributes["value"] = EncryptionHelper.Decryptdata(ContactInfo.Password);
                txtCntConfirmPassword.Attributes["value"] = EncryptionHelper.Decryptdata(ContactInfo.Password);                
