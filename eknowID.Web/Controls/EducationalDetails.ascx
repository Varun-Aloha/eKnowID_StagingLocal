<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EducationalDetails.ascx.cs"
    Inherits="eknowID.Controls.EducationalDetails" %>
...
<div id="EducationInfoContainer" class="width100per">
    ...
    <div id="divUserPost" class="marginTop20 border1Solid padding21 width100per"
        ...
        <div class="floatRight removebtn" title="Remove" style="margin-top: -20px; margin-right: -20px;">
            <img src="../Images/close_20x20.png" alt="" class="remove cursorPointer" style="padding-right: 10px;"
                id="btnRemovePostGraduation" onclick="Hide();" runat="server"/></div>
