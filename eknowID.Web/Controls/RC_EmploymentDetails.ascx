<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="RC_EmploymentDetails.ascx.cs"
    Inherits="eknowID.Controls.RC_EmploymentDetails" %>
...
<div style="height: 435px;" id="EmployeeInfoContainer" class="width100per">
    <div id="original" class="border1Solid padding21 width100per">
        <div class="floatRight removebtn">
            <img src="../Images/close_20x20.png" id="btn_1" alt="" class="remove marginTop-20 marginRight-10 displayNone cursorPointer"
