<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UpgradeAlacartReport.ascx.cs"
    Inherits="eknowID.Controls.UpgradeAlacartReport" %>
...
<div style="clear: both">
    <div id="divInnerLeft" class="floatLeft" style="background-image: url(../images/choose_plan_left_shadow.png);
        background-repeat: repeat-y; width: 10px; height: 568px;">
        &nbsp;
    </div>
    <div id="innerContainer" class="floatLeft" style="width:258px !important;">
        <div style="min-height: 567px; clear: both; background-color: White;">
            <div class="SearchByRefChosePlan_ReportIncludeDiv">
                <asp:Label runat="server" ID="lblPlanPrice" Text="" CssClass="marginTop15 floatLeft divReportSelected alaCartTotal"></asp:Label>
                <h3 class="SearchByRefChosePlan_ReportIncludeHeadNew divReportSelected floatLeft marginLeft7">
                    Package Includes
                </h3>
            </div>
                            ...
                            <table width="100%">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <td>
                                            <asp:Label runat="server" ID="lblReportPrice" Style="float: right; font-size: 14px;color:#3C3C3C !important;" CssClass="SearchByRefChosePlan_lblReportName" Text='<%#DataBinder.Eval(Container.DataItem, "Price", "{0:C}")%>'> </asp:Label>
                                        </td>
                                    </tr>
                                </table>
                            </li>
