<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/main.master" AutoEventWireup="true"
    CodeBehind="AlacartReport.aspx.cs" Inherits="eknowID.Pages.AlacartReport" %>

<%@ Register Src="~/Controls/IdentityTheftSearchByProfHeader.ascx" TagName="IdentityTheftSearchByProfHeader" TagPrefix="uc2" %>
<%@ Register Src="~/Controls/AlaCartReport.ascx" TagName="alacart" TagPrefix="uc1" %>
<%@ Register Src="~/Controls/AlacartReportSummary.ascx" TagName="alacartReportSummary"
    TagPrefix="uc3" %>
    ...
    <div class="SearchByRef_background minWidth1000px" style="height: auto !important; padding-bottom: 30px;">
        <div class="SearchByRef_mainDiv">
            <div class="margintop40">
                <uc2:IdentityTheftSearchByProfHeader ID="ucSearchHeader" runat="server" />
            </div>
        </div>
        <div class="margin_left_right_auto" style="width: 1000px;">
            <div class="divAlacartInner floatLeft marginLeft5">
        ...
        <asp:Button ID="btnChooseReport" runat="server" 
                    OnClick="btnChooseReport_Click" ClientIDMode="Static" />
    </div>
           
        </div>
        <%--<div class="clearBoth width1000px margin_left_right_auto height_30px paddingTop15">
         <div style="width:700px;height:30px;">          
         <input type="button" id="btnNext"  onclick="return CheckIfUserloggedIn();" class="floatRight alacartNextBtn" disabled="disabled"/>
         </div>
        </div>--%>
    </div>
</asp:Content>
