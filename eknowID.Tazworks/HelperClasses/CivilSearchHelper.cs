...
namespace TazWorksCom.HelperClasses {
    public class CivilSearchHelper {
        public static bool IsCivilSearchIncluded(int OrderId) {
            ...
            if (order != null) {
                ...
                if (planId != Constant.UNCOVER_YOUR_BACKGROUND_PLANID) {
                    ...
                    foreach (PlanReport plnReport in planReport) {
                        ...
                        if (plnReport.Report.Name == Constant.CIVIL_SEARCH) {
                            isInclued = true;
                            break;
                        }
                    }
