...
namespace EknowIDData.Implementations
{
    public class Repository<E> : IRepository<E>
        where E : class
    {
        private readonly ObjectContext _ctx= new EknowIDContext();
        ...
        public Repository()
        {
            //_ctx = new EknowIDContext();
        }

        //public Repository(ObjectContext session)
        //{
        //    _ctx = session;
        //}

        public Repository(String keyProperty)
        {
        ...
        public void LoadRelatedProperties(object entity,String[] properties)
        {
            foreach (string curPorperty in properties)
            {
                _ctx.LoadProperty(entity, curPorperty);
            }
        }
    }
}
